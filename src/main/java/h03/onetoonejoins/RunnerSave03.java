...
public class RunnerSave03 {
	...
	public static void main(String[] args) {
		...
		Student03 std2 = new Student03 (102, "Daulet",12, dairy2);
		Student03 std3 = new Student03 (103, "Esma",12, dairy3);
				
		dairy.setStudent(std1);
		dairy2.setStudent(std2);
		
		Configuration con = new Configuration().configure("hibernate.cfg.xml")
				.addAnnotatedClass(Dairy.class).addAnnotatedClass(Student03.class);
